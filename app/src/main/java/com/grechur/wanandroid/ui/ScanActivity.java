...
import com.grechur.wanandroid.ui.fragment.ScanFragment;
...
//        mZXingView.startSpotAndShowRect(); // 显示扫描框，并开始识别
        ...
        ActivityCompat.requestPermissions(this,params,REQUEST_CODE_ASK_PERMISSIONS);
    }
        ...
        switch (requestCode) {
            case REQUEST_CODE_ASK_PERMISSIONS:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    fragmentManager.beginTransaction().add(R.id.container,scanFragment).commit();
                } else {
                    // Permission Denied
                    ToastUtils.show("CAMERA Denied");
                }
                break;
            default:
                super.onRequestPermissionsResult(requestCode, permissions, grantResults);
...
//        mZXingView.startSpotAndShowRect(); // 显示扫描框，并开始识别
        ...
        if (resultCode == Activity.RESULT_OK ) {
            final String picturePath = data.getDataString();
